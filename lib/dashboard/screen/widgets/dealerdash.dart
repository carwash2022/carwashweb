...
import 'package:carweb/dashboard/screen/widgets/dealerform.dart';
  ...
  Widget build(BuildContext context) {
      ...
      return Card(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Center(child: Text(" Dealer Analytics", style: GoogleFonts.poppins(color: Colors.orangeAccent, fontWeight: FontWeight.bold, fontSize: 35),)),

              Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  dashborddata(Colors.red,"19000","Total Card Issued"),
                 ...
                 child: Imagecontaoiner("Add Dealer")),
                  ),
